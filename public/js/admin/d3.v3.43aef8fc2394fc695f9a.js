...
d3 = function () {
  function n(n) {
    ...
    function r() {
      ...
      var t,
          e = new RegExp("^__on([^.]+)" + mo.requote(n) + "$");for (var r in this) {
        if (t = r.match(e)) {
    ...
    function u() {
      ...
      if (2 === arguments.length && "function" == typeof r && (u = r, r = null), c.open(e, n, !0), null == t || "accept" in a || (a.accept = t + ",*/*"), c.setRequestHeader) for (var s in a) {
    ...
    var i = [],
      ...
      for (var a = 0, c = e, l = o.length; l > a; ++a) {
        ...
        }f = s.points, u.lineStart();do {
          if (s.visited = s.other.visited = !0, s.entry) {
            if (s.subject) for (var a = 0; a < f.length; a++) {
              u.point((h = f[a])[0], h[1]);
            } else r(s.point, s.next.point, 1, u);s = s.next;
          } else {
            if (s.subject) {
              f = s.prev.points;for (var a = f.length; --a >= 0;) {
                u.point((h = f[a])[0], h[1]);
              }
    ...
    var n,
        ...
        n.push([t, e]);
      }, lineEnd: c, buffer: function buffer() {
    ...
    function t(n, t) {
      ...
      var e, i, c, l, s;return { lineStart: function lineStart() {
          l = c = !1, s = 1;
    ...
    function u(r, u) {
      ...
      function l(n) {
        ...
        n = Math.max(-Ja, Math.min(Ja, n)), t = Math.max(-Ja, Math.min(Ja, t));var e = h(n, t);if (y && M.push([n, t]), k) x = n, b = t, _ = e, k = !1, e && (c.lineStart(), c.point(n, t));else if (e && E) c.point(n, t);else {
          ...
          N = c,
          T = Jt(),
          q = { point: g, lineStart: p, lineEnd: d, polygonStart: function polygonStart() {
          c = T, m = [], y = [], A = !0;
        }, polygonEnd: function polygonEnd() {
    ...
    function t(t) {
      function r(e, r) {
        ...
        e(M, x, y, b, _, w, g, p, f, d, v, m, i, t), S.lineEnd = a, a();
          ...
          _,
          w,
          S = { point: r, lineStart: u, lineEnd: a, polygonStart: function polygonStart() {
    ...
    var e = Math.cos(n),
      ...
      var c = o * t;null != u ? (u = qe(e, u), i = qe(e, i), (o > 0 ? i > u : u > i) && (u += o * Wo)) : (u = n + o * Wo, i = n - .5 * c);for (var l, s = u; o > 0 ? s > i : i > s; s -= c) {
    ...
    if (t.length < 1 || n.length != t.length && n.length != t.length + 2) return Xe(n);var e = n.length != t.length,
      ...
      a = t[1], i = n[c], c++, r += "C" + (u[0] + o[0]) + "," + (u[1] + o[1]) + "," + (i[0] - a[0]) + "," + (i[1] - a[1]) + "," + i[0] + "," + i[1];for (var l = 2; l < t.length; l++, c++) {
    ...
    if (n.length < 3) return Xe(n);var t = 1,
        ...
        o = [u, u, u, (r = n[1])[0]],
        a = [i, i, i, r[1]],
        c = [u, ",", i, "L", or(vc, o), ",", or(vc, a)];for (n.push(n[e - 1]); ++t <= e;) {
      r = n[t], o.shift(), o.push(r[0]), a.shift(), a.push(r[1]), ar(c, o, a);
    }return n.pop(), c.push("L", r), c.join("");
  }function rr(n) {
    if (n.length < 4) return Xe(n);for (var t, e = [], r = -1, u = n.length, i = [0], o = [0]; ++r < 3;) {
    ...
    var e = n.length - 1;if (e) for (var r, u, i = n[0][0], o = n[0][1], a = n[e][0] - i, c = n[e][1] - o, l = -1; ++l <= e;) {
    ...
    var e,
        ...
        c = 0,
        l = [],
        s = [];for (n += "", t += "", Mc.lastIndex = 0, r = 0; e = Mc.exec(t); ++r) {
      ...
      if (o = s[r], o.x == e[0]) {
        if (o.i) {
          if (null == l[o.i + 1]) for (l[o.i - 1] += o.x, l.splice(o.i, 1), u = r + 1; i > u; ++u) {
            s[u].i--;
          } else for (l[o.i - 1] += o.x + l[o.i + 1], l.splice(o.i, 2), u = r + 1; i > u; ++u) {
            s[u].i -= 2;
          }
        } else if (null == l[o.i + 1]) l[o.i] = o.x;else for (l[o.i] = o.x + l[o.i + 1], l.splice(o.i + 1, 1), u = r + 1; i > u; ++u) {
          s[u].i--;
        }s.splice(r, 1), i--, r--;
    ...
    if (n === t) return n;for (var e = Kr(n), r = Kr(t), u = e.pop(), i = r.pop(), o = null; u === i;) {
      o = u, u = e.pop(), i = r.pop();
    }return o;
  }function nu(n) {
    n.fixed |= 2;
    ...
    function u(n) {
      ...
      var n = $u(r),
        ...
        } else for (o.push(i(l)); l++ < s;) {
          for (var h = f - 1; h > 0; h--) {
            o.push(i(l) * h);
          }
        }for (l = 0; o[l] < a; l++) {}for (s = o.length; o[s - 1] > c; s--) {}o = o.slice(l, s);
      }return o;
    ...
    var i = n.__transition__ || (n.__transition__ = { active: 0, count: 0 }),
      ...
      var a = r.time;o = i[e] = { tween: new u(), time: a, ease: r.ease, delay: r.delay, duration: r.duration }, ++i.count, mo.timer(function (r) {
        function u(r) {
          ...
          if (i.active !== e) return l();for (var u = r / g, a = f(u), c = p.length; c > 0;) {
            p[--c].call(n, a);
    ...
    function r(t) {
      ...
      function e(e) {
        return !isNaN(e) && !n.range(e, ho(+e + 1), t).length;
          ...
          o = $u(i),
          a = null == n ? u(o, 10) : "number" == typeof n && u(o, n);return a && (n = a[0], t = a[1]), r.domain(Ju(i, t > 1 ? { floor: function floor(t) {
          for (; e(t = n.floor(t));) {
            t = ho(t - 1);
          }return t;
        }, ceil: function ceil(t) {
    ...
    if (!(u = arguments.length)) return [];for (var n = -1, e = mo.min(arguments, t), r = new Array(e); ++n < e;) {
    ...
    function n(t, a, c) {
      if (c >= o.length) return r ? r.call(i, a) : e ? a.sort(e) : a;for (var l, s, f, h, g = -1, p = a.length, d = o[c++], v = new u(); ++g < p;) {
    ...
    var t = new i();if (n) for (var e = 0, r = n.length; r > e; ++e) {
      t.add(n[e]);
    }return t;
    ...
    var t,
      ...
      i.push(t = []), t.parentNode = (r = this[o]).parentNode;for (var c = -1, l = r.length; ++c < l;) {
    ...
    var t,
        e,
        r = [];n = v(n);for (var u = -1, i = this.length; ++u < i;) {
      for (var o = this[u], a = -1, c = o.length; ++a < c;) {
        (e = o[a]) && (r.push(t = Mo(n.call(e, e.__data__, a, u))), t.parentNode = e);
      }
    }return p(r);
  };var Yo = { svg: "http://www.w3.org/2000/svg", xhtml: "http://www.w3.org/1999/xhtml", xlink: "http://www.w3.org/1999/xlink", xml: "http://www.w3.org/XML/1998/namespace", xmlns: "http://www.w3.org/2000/xmlns/" };mo.ns = { prefix: Yo, qualify: function qualify(n) {
      var t = n.indexOf(":"),
    ...
    function e(n, e) {
      ...
      for (n = new Array(a = (r = this[0]).length); ++o < a;) {
        ...
        l = p([]),
        s = p([]);if ("function" == typeof n) for (; ++o < a;) {
    ...
    n = A.apply(this, arguments);for (var t = -1, e = this.length; ++t < e;) {
      this[t].sort(n);
    }return this.order();
  }, Ro.each = function (n) {
    ...
    for (var t, e, r, u, i, o = [], a = -1, c = this.length; ++a < c;) {
      r = (u = this[a]).update, o.push(t = []), t.parentNode = u.parentNode;for (var l = -1, s = u.length; ++l < s;) {
    ...
    for (var n, t, e = Oc || ++Zc, r = [], u = Rc || { time: Date.now(), ease: Cr, delay: 0, duration: 250 }, i = -1, o = this.length; ++i < o;) {
      r.push(n = []);for (var a = this[i], c = -1, l = a.length; ++c < l;) {
  ...
  };var Ca = { Feature: function Feature(n, t) {
      Nt(n.geometry, t);
    ...
    return ja = 0, mo.geo.stream(n, Ha), ja;
      ...
      La = new kt(),
      Ha = { sphere: function sphere() {
      ja += 4 * Bo;
    }, point: c, lineStart: c, lineEnd: c, polygonStart: function polygonStart() {
    ...
    function n(n, t) {
      ...
      g = h = -(s = f = 1 / 0), M = [], mo.geo.stream(n, b);var t = M.length;if (t) {
        M.sort(c);for (var e, r = 1, u = M[0], i = [u]; t > r; ++r) {
    ...
    Fa = Pa = Oa = Ra = Ya = Ia = Ua = Za = Va = Xa = $a = 0, mo.geo.stream(n, Ba);var t = Va,
      ...
      Xa,
      $a,
      Ba = { sphere: c, point: Rt, lineStart: It, lineEnd: Ut, polygonStart: function polygonStart() {
      Ba.lineStart = Zt;
    }, polygonEnd: function polygonEnd() {
      Ba.lineStart = It;
    } },
    ...
    function n(n) {
      ...
      tc,
      ec,
      rc = { point: c, lineStart: c, lineEnd: c, polygonStart: function polygonStart() {
      ...
      ic = { point: he, lineStart: ge, lineEnd: pe, polygonStart: function polygonStart() {
      ic.lineStart = de;
    }, polygonEnd: function polygonEnd() {
      ic.point = he, ic.lineStart = ge, ic.lineEnd = pe;
    } };mo.geo.transform = function (n) {
    return { stream: function stream(t) {
        var e = new ye(t);for (var r in n) {
          e[r] = n[r];
        }return e;
      } };
  }, ye.prototype = { point: function point(n, t) {
    ...
    function t(n) {
      if (n.length < 3) return [];var t,
          ...
          M = [],
          x = [],
          b = 0;if (d === Ze && r === Ve) t = n;else for (i = 0, t = []; m > i; ++i) {
    ...
    function t(n) {
      var t,
        ...
        return [];
          ...
          l = pt(r),
          s = n.length,
          f = 1e6;if (c === Ze && l === Ve) t = n;else for (t = new Array(s), o = 0; s > o; ++o) {
      ...
      var t,
        ...
        return [];
          ...
          c = pt(e),
          l = pt(r),
          s = n.length;if (c === Ze && l === Ve) t = n;else for (t = new Array(s), i = 0; s > i; ++i) {
      ...
      if (e === Ze && r === Ve) return mo.geom.delaunay(n);for (var t, u = new Array(c), i = pt(e), o = pt(r), a = -1, c = n.length; ++a < c;) {
    ...
    function i(n) {
      function i(n, t, e, r, u, i, o, a) {
        ...
        var l = .5 * (u + a),
          ...
          y,
          M = pt(a),
          x = pt(c);if (null != t) d = t, v = e, m = r, y = u;else if (m = y = -(d = v = 1 / 0), f = [], h = [], p = n.length, o) for (g = 0; p > g; ++g) {
    ...
    var e = typeof t === "undefined" ? "undefined" : _typeof(t);return ("string" === e ? da.has(t) || /^(#|rgb\(|hsl\()/.test(t) ? br : Sr : t instanceof Z ? br : "object" === e ? Array.isArray(t) ? kr : _r : wr)(n, t);
  }], mo.interpolateArray = kr;var xc = function xc() {
    return dt;
  },
      bc = mo.map({ linear: xc, poly: Dr, quad: function quad() {
      return qr;
      ...
      return Hr;
    }, elastic: Fr, back: Pr, bounce: function bounce() {
      return Or;
    } }),
      _c = mo.map({ "in": dt, out: Nr, "in-out": Tr, "out-in": function outIn(n) {
      return Tr(Nr(n));
    } });mo.ease = function (n) {
    var t = n.indexOf("-"),
    ...
    function n(n) {
      ...
      }if (g) for (uu(t = mo.geom.quadtree(v), r, o), e = -1; ++e < b;) {
      ...
      function n(n, r) {
      ...
      }if (u = [], "function" == typeof f) for (e = 0; d > e; ++e) {
        ...
        i[e] = h;
      }if (o = [], "function" == typeof g) for (e = 0; p > e; ++e) {
    ...
    function n(t, o, a) {
      ...
      var u = n.children,
          o = 0;if (u && (a = u.length)) for (var a, c = -1, l = r + 1; ++c < a;) {
        o += t(u[c], l);
    ...
    function n(t, e, r, u) {
      var i = t.children;if (t.x = e, t.y = t.depth * u, t.dx = r, t.dy = u, i && (o = i.length)) {
        var o,
            a,
            c,
            l = -1;for (r = t.value ? r / t.value : 0; ++l < o;) {
    ...
    function n(a, c) {
  ...
  };var Ac = mo.map({ "inside-out": function insideOut(n) {
      var t,
          e,
          r = n.length,
          u = n.map(du),
      ...
      Nc = mo.map({ silhouette: function silhouette(n) {
      var t,
          e,
          r,
          u = n.length,
    ...
    function n(n, i) {
      function o(n, t) {
        var r = n.children,
          ...
          }Tu(n);var g = .5 * (s._tree.prelim + l._tree.prelim);t ? (u.prelim = t._tree.prelim + e(n, t), u.mod = u.prelim - g) : u.prelim = g;
    ...
    function n(n, t) {
      ...
      var i = e.children;if (i && i.length) {
        var o,
            ...
            h = i.slice(),
            p = 1 / 0,
            d = "slice" === g ? l.dx : "dice" === g ? l.dy : "slice-dice" === g ? 1 & e.depth ? l.dy : l.dx : Math.min(l.dx, l.dy);for (n(h, l.dx * l.dy / e.value), s.area = 0; (c = h.length) > 0;) {
      ...
      function t(t) {
        ...
        return Xu(t, n);
      }if (!arguments.length) return s;var r;return f = null == (s = n) ? Vu : "function" == (r = typeof n === "undefined" ? "undefined" : _typeof(n)) ? t : "number" === r ? (n = [n, n, n, n], e) : e, i;
    }, i.round = function (n) {
  ...
  }, mo.random = { normal: function normal(n, t) {
  ...
  };var Pc = mo.map({ circle: Si, cross: function cross(n) {
    ...
    var t,
        ...
        u = this.id,
        i = [];n = d(n);for (var o = -1, a = this.length; ++o < a;) {
      i.push(t = []);for (var c = this[o], l = -1, s = c.length; ++l < s;) {
    ...
    var t,
        ...
        i,
        o = this.id,
        a = [];n = v(n);for (var c = -1, l = this.length; ++c < l;) {
    ...
    for (var n, t, e, r, u = this.id, i = ++Zc, o = [], a = 0, c = this.length; c > a; a++) {
      o.push(n = []);for (var t = this[a], l = 0, s = t.length; s > l; l++) {
    ...
    function n(i) {
      ...
      Wc = mo.time = {},
      Jc = Date,
      Gc = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];zi.prototype = { getDate: function getDate() {
    ...
    }, x: ji(nl), X: ji(tl), y: function y(n, t) {
  ...
  };var El = { range: function range(n, t, e) {
