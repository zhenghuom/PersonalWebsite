...
mix.js('resources/assets/js/app.js', 'public/js')
    ...
    .js('resources/assets/js/admin/jquery.min.js', 'public/js/admin')
    ...
    /*.js('resources/assets/js/admin/rickshaw.js', 'public/js/admin')*/
    ...
    .less('resources/assets/css/home.less', 'public/css')
    .less('resources/assets/css/common.less', 'public/css')
